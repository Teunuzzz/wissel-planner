...
- Overige features: timer + Wissel NU, wijzigingen-tab, Speler stopt + herbereken, bench-cooldown, strikte eerlijkheid, keeper 1/2/4, PWA.

Na upload naar GitHub Pages: harde refresh (cache-tag: `v2_3_8`).